// AdminLoginScreen.dart (FIXED - Keyboard doesn't push UI)
...
class _AdminLoginScreenState extends State<AdminLoginScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<AdminLoginBloc>(
      ...
      child: Scaffold(
        ...
        // *** KEY FIX: Add resizeToAvoidBottomInset: false ***
        ...
        body: BlocListener<AdminLoginBloc, AdminLoginState>(
          ...
          listener: (context, state) {
            ...
            if (state is AdminLoginSuccess) {
              print('Login success - Role: ${state.role}');
              _passwordController.clear();
              ...
              if (state.role == AdminRole.superAdmin) {
                ...
                destinationPage = SuperAdminDashboard();
              } else {
  ...
  Widget _buildBody() {
    ...
    // *** FIXED: Remove keyboard-dependent height calculations ***
